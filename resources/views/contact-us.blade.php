...
<x-guest-layout>
    <div class="bg-gray-100 dark:bg-gray-900" id="contact">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 grid md:grid-cols-2 lg:grid-cols-2 gap-y-8 md:gap-x-8 md:gap-y-8 lg:gap-x-8 lg:gap-y-16">
            <div>
                ...
                <div class="flex items-center mt-8 space-x-2 text-dark-600 dark:text-gray-400">
                    ...
                    <span>
                        NO 202, HUSSAIN NASSERLOOTHA & SAUD HUMAIDAM BLDG, AL NAKHEEL ROAD, DEIRA, DUBAI, U.A.E.
                    </span>
                </div>
                <div class="flex items-center mt-2 space-x-2 text-dark-600 dark:text-gray-400">
                    ...
                    <a href="mailto:support@canarylogisticsllc.com">support@canarylogisticsllc.com</a>
                </div>
                <div class="flex items-center mt-2 space-x-2 text-dark-600 dark:text-gray-400">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                         stroke="currentColor" aria-hidden="true" class="w-4 h-4">
            ...
            <div>
                <form method="POST" action="{{route('feedback.submit')}}">
                    ...
                    <div class="mb-3">
                    <textarea placeholder="Your Message" autocomplete="false"
                    ...
                    <button type="submit"
                            class="w-full py-4 font-semibold text-white transition-colors bg-indigo-600 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-offset-2 focus:ring focus:ring-indigo-200 px-7 dark:bg-white dark:text-black ">Send
                        Message
                    </button>
                </form>
            </div>
